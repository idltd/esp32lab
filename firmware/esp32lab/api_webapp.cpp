...
#tab-content { flex: 1; overflow-y: auto; -webkit-overflow-scrolling: touch; overscroll-behavior: none; }
...
function updateSafetyInfo(id) {
    ...
    if (!id) { safetyEl.style.display = 'none'; wiringEl.style.display = 'none'; return; }
